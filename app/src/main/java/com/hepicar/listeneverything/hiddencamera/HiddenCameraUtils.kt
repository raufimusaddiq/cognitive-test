...
object HiddenCameraUtils {
     ...
     */
    internal fun getCacheDir(context: Context): File {
     ...
     */
    @WorkerThread
    internal fun rotateBitmap(bitmap: Bitmap, @CameraRotation.SupportedRotation rotation: Int): Bitmap {
        val matrix = Matrix()
     ...
     */
    internal fun saveImageFromFile(
        bitmap: Bitmap,
        fileToSave: File,
        ...
        when (imageFormat) {
            CameraImageFormat.FORMAT_JPEG -> compressFormat = Bitmap.CompressFormat.JPEG
            CameraImageFormat.FORMAT_WEBP -> compressFormat = Bitmap.CompressFormat.WEBP
            CameraImageFormat.FORMAT_PNG -> compressFormat = Bitmap.CompressFormat.PNG
            else -> compressFormat = Bitmap.CompressFormat.PNG
        }
